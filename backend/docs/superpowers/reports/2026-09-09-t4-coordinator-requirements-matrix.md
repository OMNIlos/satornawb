...
| 3. Policies/drafts/decisions | 98d1331 decisions;4b349ec/92ba34c serializers;316eaf8 audit encoder; accepted a35b657/b7c3bb1 replay/epoch contract, later actual localcommand/result codec; not durable services | New61 codec + adjacent157 =218PASS0warnings0.20s; eight literal request/result goldens. No DB admission or replay acceptance implied | T1 bounded local policy/draft/head/decision/audit/receipt DDL with epoch witness; then T4 fake-generation, authenticated CAS/approval+audit and restart/races. See local-command-codec handoff | Not authorized; local implementation must not wait for real LLM credentials |
