"""materialize daily finance components for period P&L reads
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("nm_id >= 0", name="ck_wb_finance_daily_pnl_rollups_nm_id"),
...
def downgrade() -> None:
    ...
    op.drop_table(TABLE)
    op.drop_column("wb_finance_sync_runs", "is_daily_pnl_rollup_materialized")
